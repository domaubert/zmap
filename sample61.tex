...
\begin{abstract}
The Reionization as experienced by galaxies is a diverse and heterogeneous process. We probe this diversity by presenting predictions of the Reionization times of z=0 galaxies environments, made using simulations. The  $z>6$  epoch is described using the CODA~I-AMR radiative hydrodynamics simulation produced with the EMMA code.
...
8 billions initial resolution elements,  allowing to probe z=0 halos in the $10^8-10^{13} M_\odot$ range. 
